package com.dj.parkinsondetector.utils;

import android.content.Context;
import android.content.SharedPreferences;


import com.dj.parkinsondetector.ParkinsonApplication;
...
public class SharedPreferenceManager {
    ...
    private SharedPreferenceManager() {
        ...
        mSharedPreference = ParkinsonApplication.getInstance().getSharedPreferences(PREFERENCES, Context.MODE_PRIVATE);
